...
- The third page contains a form that allows employers to contact me, along with a text input field to enter a reason why. The purpose of this is to seperate the form entries of potential employers from other types of contact attempts, making it easier for myself to sort through later. Each input field also has an associated aria-label to make them interactable with text-to-speech and screen reader devices for accessibility purposes.
## Color Scheme
[Go to top](#table-of-contents)
...
![Image displaying the lighthouse report generated for the about me page](assets/images/readme-images/lighthouse-report-about-me.png)

### **My history page**

![Image displaying the lighthouse report generated for the my history page](assets/images/readme-images/lighthouse-report-my-history.png)

### **Contact me page**

![Image displaying the lighthouse report generated for the contact me page](assets/images/readme-images/lighthouse-report-contact-me.png)
...
![Image displaying the about me page using the am I responsive tool](assets/images/readme-images/amiresponsive-index.png)

### **My history page**

![Image displaying the my history page using the am I responsive tool](assets/images/readme-images/amiresponsive-history.png)

### **Contact me page**

![Image displaying the contact me page using the am I responsive tool](assets/images/readme-images/amiresponsive-contact-me.png)
...
![Image displaying the errors that appeared when I validated the code for the about me page](assets/images/readme-images/W3C-index.html-Validator-Errors-1.png)

### **My history page**

![Image displaying the errors that appeared when I validated the code for the my history page](assets/images/readme-images/W3C-my-history.html-Validator-Errors-1.png)
...
![Image displaying the W3C Validator found no errors in the code for the about me page](assets/images/readme-images/W3C-index.html-Validator-Fixed.png)

### **My history page**

![Image displaying the W3C Validator found no errors in the code for the my history page](assets/images/readme-images/W3C-my-history.html-Validator-Fixed.png)

### **Contact me page**

![Image displaying the W3C Validator found no errors in the code for the contact me page](assets/images/readme-images/W3C-contact-me.html-Validator-Fixed.png)

### **CSS Code**

![Image displaying the W3C Validator found no errors in the css code](assets/images/readme-images/W3C-css-Validator-No-errors.png)
